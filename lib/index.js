/**
 * dsh-pixel-liangzu — node/host half.
 *
 * Serves the 30 state GIFs (6 tiers × 5 states) from
 * `/plugins/dsh-pixel-liangzu/gifs/…`. The browser half addresses them as
...
const GIF_PREFIX = '/plugins/dsh-pixel-liangzu/gifs';
...
export function apply(ctx) {
  ...
  }), 'dsh-pixel-liangzu: state gif images');
}
